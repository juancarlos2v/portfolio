...
const AboutMe = () => {
    ...
    return (
        <div id="aboutme" className="container-section col-12 h-xl-100 h-md-auto h-lg-100 d-flex flex-column align-items-start justify-content-center">
            <p >SOBRE MI |</p>
            <div className="col-12 d-flex flex-lg-row align-items-center mt-5">
                ...
                <div className="col-7 col-sm-6 col-md-8 p-2 col-lg-8 p-0">
                    ...
                    <p className="description" >Hola, soy Juan Carlos, desarrollador apasionado por la tecnología y el diseño. A lo largo de mi carrera, he tenido el privilegio de formar parte de equipos multidisciplinarios que valoran tanto la creatividad como la funcionalidad.
                        ...
                        <br /> <span className="d-none d-md-inline">
