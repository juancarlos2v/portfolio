        ...
        <div className="container">
            ...
            <div className="row flex-wrap p-lg-0 p-4">
                < div className="col-lg-6 col-md-12 d-flex flex-column  justify-content-center aling-items-center" >
                    ...
                    <div className="mt-4  col-12 d-flex justify-content-lg-start justify-content-md-between">
                        <a className="col-lg-4 col-xs-12 col-md-6" href={repositories[project].code} target="_blank">Codigo</a>
                        {repositories[project].deploy == "#/" ? <div></div> : <a className="col-lg-8 col-xs-12 col-md-6" href={repositories[project].deploy} target="_blank">Despliegue</a>}
                    </div>
                </div>
                <button className="col-lg-1 col-12 m-lg-0  m-md-3 d-flex justify-content-center align-items-center" onClick={changeContent}>
